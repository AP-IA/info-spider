...
window.onload = function () {
    ...
    chrome.storage.sync.set({'oschinanames':document.getElementsByTagName('span')[3].innerHTML});
    ...
    for(var i=4;i<8;i++)
    {
        ...
        if(i==6) 
        {
          chrome.storage.sync.set({'oschinafollowers':t});
          console.log(t)
          t="粉丝:"+t;
        ...
        if(i==7) {
          chrome.storage.sync.set({'oschinafollowing':t});
          console.log(t)
          t="关注:"+t;
