window.onload = function () {
   ...
   console.log(document.getElementById('header_user_left').innerHTML)
   chrome.storage.sync.set({'cnblognames':document.getElementById('header_user_left').innerHTML})
    for(var i=12;i<=14;i++)
    {
    ...
    chrome.storage.sync.set({'cnblogfollowing':document.getElementById('following_count').innerHTML})
    data.push("粉丝数")
    chrome.storage.sync.set({'cnblogfollower':document.getElementById('follower_count').innerHTML})
